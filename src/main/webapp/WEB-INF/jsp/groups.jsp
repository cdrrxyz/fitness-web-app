...
<head>
    ...
    <script type="text/javascript" src="/resources/javascript/groups.js"></script>
</head>
<body>
        ...
        <div class="flex-col flex-auto self-start groups space-y-16">
            <div class="flex-col section_4">
                <div class="flex-row justify-between">
                    <span class="font_3">Groups</span>
                    <span id="open_create_dialog" class="font_3 text_3">+</span>
                </div>
                <div id="group_list">
                </div>
            </div>
            <div id="chat_div" style="display: none" class="flex-col section_5">
                <div class="flex-row justify-between group_3">
                    <span id="chat_group_title" class="font_3">Name: XXX</span>
                    <span id="open_edit_dialog" class="font_3">…</span>
                </div>
                <div id="chat_list">
                    <div class="flex-row group_4">
                        <div class="shrink-0 section_6"></div>
                        <div class="flex-col justify-start items-start input text-wrapper_3">
                            <span class="font_4 text_5">AAAAA</span>
                        </div>
                    </div>
                    <div style="margin-top: 1rem" class="flex-row group_6">
                        <div class="flex-col justify-start items-end text-wrapper_4 button">
                            <span class="font_4 text_6">BBBBB</span>
                        </div>
                        <div class="shrink-0 section_6 view"></div>
                    </div>
                </div>
                <div class="flex-row group_7">
                    <input id="input_send" type="text" class="text-wrapper_4 section_7">
                    <div id="btn_send" class="flex-col justify-start shrink-0 button view_2"><span class="font_5 text_7">Send</span></div>
                </div>
            </div>
            ...
            <div id="dialog" class="flex-col section_8">
                <div class="flex-row justify-between group_8">
                    <span id="dialog_title" class="font_3">Create groups</span>
                    <span id="close_dialog" class="font_3 text_8">x</span>
                </div>
                <input id="input_name" style="width: 100%" type="text" placeholder="Name" class="section_9 input_2">
                <input id="input_steps" style="width: 100%" type="text" placeholder="Steps" class="section_10 input_2">
                <input id="input_calorie" style="width: 100%" type="text" placeholder="Calorie" class="section_10 input_2">
                <div class="flex-col group_9">
                    <input id="input_time" style="width: 100%" type="text" placeholder="Time" class="section_9 input_2">
                    <div id="user_list" class="flex-col">
                    </div>
